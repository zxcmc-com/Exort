...
public class WireListener implements Listener {
    private static final org.bukkit.block.BlockFace[] FACES = new org.bukkit.block.BlockFace[]{org.bukkit.block.BlockFace.UP, org.bukkit.block.BlockFace.DOWN, org.bukkit.block.BlockFace.NORTH, org.bukkit.block.BlockFace.SOUTH, org.bukkit.block.BlockFace.EAST, org.bukkit.block.BlockFace.WEST};
    ...
    public WireListener(ExortPlugin plugin, StorageKeys keys, int wireLimit, int wireHardCap, Material wireMaterial, long peekDurationTicks, Material storageCarrier) {
        this.plugin = plugin;
        this.keys = keys;
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        plugin.getBossBarManager().showWireStatus(info.wires(), wireLimit, tooLong, info.storageConnected(), event.getPlayer(), peekDurationTicks);

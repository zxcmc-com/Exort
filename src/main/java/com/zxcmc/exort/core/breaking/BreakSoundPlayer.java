...
public final class BreakSoundPlayer {
    ...
    static {
        ...
        try {
            method = Player.class.getMethod("playSound", Location.class, String.class, SoundCategory.class, float.class, float.class);
    ...
    public static void play(World world, Location location, String key, double range, float volume, float pitch) {

...
public final class BreakConfig {
    ...
    public BreakConfig(BreakSettings storage, BreakSettings terminal, BreakSettings monitor, BreakSettings bus, BreakSettings wire) {
    ...
    private static BreakSettings load(FileConfiguration config, Logger logger, String path, double defaultHardness, Set<Material> defaults) {

...
public class Lang {
    ...
    private void loadDefaults() {
        ...
        put(defaultsEn, "message.multiple_storages_adjacent", "Multiple storages are connected. Leave only one.");
        ...
        put(defaultsEn, "message.give_usage", "Usage: /exort give <player> storage <tier> [amount] | terminal [amount] | crafting_terminal [amount] | monitor [amount] | import_bus [amount] | export_bus [amount] | wire [amount]");
        ...
        put(defaultsEn, "message.usage_debug", "Usage: /exort debug player <player> | /exort debug storage <storageId> [write] | /exort debug cache status <storageId|player> | /exort debug verbose cache start [mode] [storage <uuid>] | /exort debug verbose cache stop | /exort debug benchmark start [players] [seconds] | /exort debug benchmark stop");
        put(defaultsEn, "message.usage_give", "Usage: /exort give <player> storage <tier> [amount] | terminal [amount] | crafting_terminal [amount] | monitor [amount] | import_bus [amount] | export_bus [amount] | wire [amount]");
        ...
        put(defaultsEn, "message.help_debug", "/{0} debug player <player> | /{0} debug storage <id> [write] | /{0} debug cache status <id|player> | /{0} debug verbose cache start [mode] [storage <uuid>] | /{0} debug verbose cache stop | /{0} debug benchmark start [players] [seconds] | /{0} debug benchmark stop - debug access");
        put(defaultsEn, "message.help_give", "/{0} give <player> storage <tier> [amount] | terminal [amount] | crafting_terminal [amount] | monitor [amount] | import_bus [amount] | export_bus [amount] | wire [amount] - give items");
        put(defaultsEn, "message.help_reload", "/{0} reload - reload config and language");
        put(defaultsEn, "message.help_lang", "/{0} lang status | /{0} lang refresh - language dictionaries");
        put(defaultsEn, "message.help_mode", "/{0} mode info | /{0} mode set <VANILLA | RESOURCE> - switch mode");
        put(defaultsEn, "message.help_version", "/{0} version - show plugin version");
        put(defaultsEn, "message.debug_load_usage", "Usage: /exort debug benchmark start [players] [seconds] | /exort debug benchmark stop");
        ...
        put(defaultsEn, "message.debug_load_progress", "Load test {0}% • {1}s left • TPS {2} • MSPT {3}");
        put(defaultsEn, "message.debug_load_verdict", "Load test verdict: {0} (TPS min {1}, max {2}, avg {3}, 0.1% {4}; MSPT min {5}, max {6}, avg {7}, p95 {8}, p99 {9})");
        put(defaultsEn, "message.debug_load_summary", "Benchmark model: players {0}, chunks {1}, storages/chunk {2}, buses/chunk {3}, monitors/chunk {4}, est ops/tick {5} (global {6}, chunk {7}), db/tick {8}, monitor updates {9}/t{10}, wire {11}/{12} miss {13}% cover {14}%, duration {15}s (warmup {16}s), jitter {17}%");
        put(defaultsEn, "message.debug_load_hints", "Benchmark hints: dominant {0}; CPU {1}%, WIRE {2}%, DISPLAYS {3}%, DB {4}%, WIRELESS {5}%.");
        ...
        put(defaultsEn, "message.debug_load_move_away", "Move {0} chunks away from Exort blocks or disable benchmark.simulateDisplays.");
        put(defaultsEn, "message.debug_cache_started", "Cache verbose logging enabled (mode: {0}, filter: {1}).");
        put(defaultsEn, "message.debug_cache_stopped", "Cache verbose logging disabled.");
        put(defaultsEn, "message.debug_cache_mode_invalid", "Unknown cache verbose mode: {0}. Use compact/normal/full.");
        ...
        put(defaultsEn, "message.debug_cache_status_cache", "Cache: loaded={0} dirty={1} viewers={2} idleMs={3} ({4}s)");
        put(defaultsEn, "message.debug_cache_status_touch", "Last touch: {0}ms ({1}s) source={2}");
        put(defaultsEn, "message.debug_cache_status_evict", "Evict: eligible={0} idleMs={1}/{2} dirty={3} viewers={4} loading={5}");
        put(defaultsEn, "message.debug_cache_status_marker_missing", "Storage marker not found in loaded chunks (chunk may be unloaded).");
        put(defaultsEn, "message.debug_cache_status_marker", "Storage block: {0} {1} {2} {3} (chunk {4},{5})");
        put(defaultsEn, "message.debug_cache_status_chunk_unloaded", "Chunk: not loaded.");
        put(defaultsEn, "message.debug_cache_status_chunk", "Chunk: loaded={0} level={1} forceLoaded={2} pluginTickets={3} players={4}");
        put(defaultsEn, "message.debug_cache_status_chunk_reason", "Chunk load reason: {0}");
        put(defaultsEn, "message.debug_cache_status_connections", "Loaded network nodes: terminals={0} monitors={1} buses={2} total={3}");
        put(defaultsEn, "message.debug_cache_status_connections_empty", "No loaded terminals/monitors/buses are linked to this storage.");
        put(defaultsEn, "message.version", "Exort v{0}");
        put(defaultsEn, "message.usage_lang", "Usage: /exort lang status | /exort lang refresh");
        put(defaultsEn, "message.usage_mode", "Usage: /exort mode info | /exort mode set <VANILLA | RESOURCE>");
        ...
        put(defaultsEn, "message.mode_blocked", "Cannot enable RESOURCE: Paper's block-updates.disable-chorus-plant-updates is not enabled.");
        ...
        put(defaultsEn, "gui.crafting.button.all_warning", "All stored items will be used. This cannot be undone!");
        ...
        put(defaultsEn, "error.search.dialogs_unsupported", "Search dialog is not supported on this server version.");
        ...
        put(defaultsEn, "message.bus.multiple_storages", "Multiple storages connected. Leave only one.");
        ...
        put(defaultsEn, "message.wireless.self_store", "Cannot store a wireless terminal inside itself.");
        ...
        put(defaultsRu, "message.multiple_storages_adjacent", "Подключено несколько хранилищ. Оставьте только одно.");
        ...
        put(defaultsRu, "message.give_usage", "Использование: /exort give <игрок> storage <tier> [кол-во] | terminal [кол-во] | crafting_terminal [кол-во] | monitor [кол-во] | import_bus [кол-во] | export_bus [кол-во] | wire [кол-во]");
        ...
        put(defaultsRu, "message.debug_player_active", "{0} сейчас использует: {1} ({2}) в {3} {4} {5} {6}");
        put(defaultsRu, "message.debug_player_last", "{0} последний раз использовал: {1} ({2}) в {3} {4} {5} {6}");
        put(defaultsRu, "message.debug_player_click", "Кликните, чтобы открыть /exort debug storage {0}");
        put(defaultsRu, "message.debug_storage_invalid", "Неверный UUID или ник игрока.");
        put(defaultsRu, "message.debug_location_unknown", "Местоположение хранилища для {0} неизвестно.");
        ...
        put(defaultsRu, "message.usage_debug", "Использование: /exort debug player <игрок> | /exort debug storage <id> [write] | /exort debug cache status <uuid|игрок> | /exort debug verbose cache start [mode] [storage <uuid>] | /exort debug verbose cache stop | /exort debug benchmark start [игроки] [секунды] | /exort debug benchmark stop");
        put(defaultsRu, "message.usage_give", "Использование: /exort give <игрок> storage <tier> [кол-во] | terminal [кол-во] | crafting_terminal [кол-во] | monitor [кол-во] | import_bus [кол-во] | export_bus [кол-во] | wire [кол-во]");
        ...
        put(defaultsRu, "message.help_debug", "/{0} debug player <игрок> | /{0} debug storage <id> [write] | /{0} debug cache status <uuid|игрок> | /{0} debug verbose cache start [mode] [storage <uuid>] | /{0} debug verbose cache stop | /{0} debug benchmark start [игроки] [секунды] | /{0} debug benchmark stop - отладка");
        put(defaultsRu, "message.help_give", "/{0} give <игрок> storage <tier> [кол-во] | terminal [кол-во] | crafting_terminal [кол-во] | monitor [кол-во] | import_bus [кол-во] | export_bus [кол-во] | wire [кол-во] - выдать предметы");
        ...
        put(defaultsRu, "message.help_mode", "/{0} mode info | /{0} mode set <VANILLA | RESOURCE> - сменить режим");
        put(defaultsRu, "message.help_version", "/{0} version - показать версию плагина");
        put(defaultsRu, "message.debug_load_usage", "Использование: /exort debug benchmark start [игроки] [секунды] | /exort debug benchmark stop");
        put(defaultsRu, "message.debug_load_running", "Тест нагрузки уже запущен.");
        put(defaultsRu, "message.debug_load_started", "Тест нагрузки запущен для {0} симулируемых игроков.");
        put(defaultsRu, "message.debug_load_stopped", "Тест нагрузки остановлен.");
        put(defaultsRu, "message.debug_load_progress", "Тест нагрузки {0}% • осталось {1}с • TPS {2} • MSPT {3}");
        put(defaultsRu, "message.debug_load_verdict", "Вердикт теста: {0} (TPS min {1}, max {2}, avg {3}, 0.1% {4}; MSPT min {5}, max {6}, avg {7}, p95 {8}, p99 {9})");
        put(defaultsRu, "message.debug_load_summary", "Модель бенчмарка: игроков {0}, чанков {1}, хранилищ/чанк {2}, шин/чанк {3}, мониторов/чанк {4}, оценка оп/тик {5} (глобал {6}, чанк {7}), БД/тик {8}, обновления мониторов {9}/t{10}, кабель {11}/{12} miss {13}% cover {14}%, длительность {15}с (прогрев {16}с), джиттер {17}%");
        put(defaultsRu, "message.debug_load_hints", "Подсказки: доминирующая нагрузка — {0}; CPU {1}%, кабель {2}%, мониторы {3}%, БД {4}%, wireless {5}%.");
        ...
        put(defaultsRu, "message.debug_load_move_away", "Отойдите на {0} чанков от блоков Exort или отключите benchmark.simulateDisplays.");
        put(defaultsRu, "message.debug_cache_started", "Подробный лог кэша включен (режим: {0}, фильтр: {1}).");
        put(defaultsRu, "message.debug_cache_stopped", "Подробный лог кэша выключен.");
        put(defaultsRu, "message.debug_cache_mode_invalid", "Неизвестный режим лога кэша: {0}. Используйте compact/normal/full.");
        ...
        put(defaultsRu, "message.debug_cache_status_cache", "Кэш: loaded={0} dirty={1} viewers={2} idleMs={3} ({4}с)");
        put(defaultsRu, "message.debug_cache_status_touch", "Последнее обращение: {0}мс ({1}с) источник={2}");
        put(defaultsRu, "message.debug_cache_status_evict", "Выгрузка: eligible={0} idleMs={1}/{2} dirty={3} viewers={4} loading={5}");
        put(defaultsRu, "message.debug_cache_status_marker_missing", "Маркер хранилища не найден в загруженных чанках (чанк может быть выгружен).");
        put(defaultsRu, "message.debug_cache_status_marker", "Блок хранилища: {0} {1} {2} {3} (чанк {4},{5})");
        put(defaultsRu, "message.debug_cache_status_chunk_unloaded", "Чанк: не загружен.");
        put(defaultsRu, "message.debug_cache_status_chunk", "Чанк: loaded={0} level={1} forceLoaded={2} pluginTickets={3} players={4}");
        put(defaultsRu, "message.debug_cache_status_chunk_reason", "Причина загрузки чанка: {0}");
        put(defaultsRu, "message.debug_cache_status_connections", "Загруженные узлы сети: terminals={0} monitors={1} buses={2} total={3}");
        put(defaultsRu, "message.debug_cache_status_connections_empty", "Нет загруженных терминалов/мониторов/шин, связанных с этим хранилищем.");
        put(defaultsRu, "message.version", "Exort Storage Network v{0} by phantomfighterxx");
        put(defaultsRu, "message.usage_lang", "Использование: /exort lang status | /exort lang refresh");
        put(defaultsRu, "message.usage_mode", "Использование: /exort mode info | /exort mode set <VANILLA | RESOURCE>");
        ...
        put(defaultsRu, "message.mode_blocked", "Нельзя включить RESOURCE: в Paper не отключены block-updates.disable-chorus-plant-updates.");
        ...
        put(defaultsRu, "gui.crafting.button.all_warning", "Будут использованы все предметы из хранилища. Это действие необратимо!");
        ...
        put(defaultsRu, "error.search.dialogs_unsupported", "Диалоги поиска не поддерживаются на этой версии сервера.");
        ...
        put(defaultsRu, "message.bus.multiple_storages", "Подключено несколько хранилищ. Оставьте только одно.");
        ...
        put(defaultsRu, "message.wireless.wrong_owner", "Вы не владелец этого терминала. Привяжите заново.");
        ...
        put(defaultsRu, "message.wireless.self_store", "Нельзя положить беспроводной терминал сам в себя.");
    ...
    public void load(String language) {
        ...
        if (changed) {
            try {
                ...
                plugin.getLogger().severe("Failed to save language file " + target.getName() + ": " + e.getMessage());
            }
        }
    }
    ...
    private void writeDefaults(File dir, String name, Map<String, String> data, boolean overwrite) {
        ...
        try {
            ...
            plugin.getLogger().severe("Failed to save default lang file " + file.getName() + ": " + e.getMessage());
        }
    }
    ...
    public void reload(String language) {
        try {
            ...
            plugin.getLogger().severe("Failed to load language '" + language + "', falling back to en_us: " + e.getMessage());
            load("en_us");
        }
    }
}

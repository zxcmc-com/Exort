...
public final class ExortBrigadier {
    ...
    public LiteralCommandNode<CommandSourceStack> build() {
        LiteralArgumentBuilder<CommandSourceStack> root = Commands.literal("exort")
        ...
        root.then(Commands.literal("debug")
                        ...
                        .then(Commands.literal("cache")
                                .then(Commands.literal("start")
                                        ...
                                        .then(Commands.literal("storage")
                                                .then(Commands.argument(ARG_STORAGE_ID, StringArgumentType.word())
                                                        .executes(ctx -> cacheVerboseStart(ctx, null, StringArgumentType.getString(ctx, ARG_STORAGE_ID)))))
                                        .then(Commands.argument(ARG_VERBOSE_MODE, StringArgumentType.word())
                                                .suggests(this::suggestVerboseModes)
                                                .executes(ctx -> cacheVerboseStart(ctx, StringArgumentType.getString(ctx, ARG_VERBOSE_MODE), null))
                                                .then(Commands.literal("storage")
                                                        .then(Commands.argument(ARG_STORAGE_ID, StringArgumentType.word())
                                                                .executes(ctx -> cacheVerboseStart(ctx, StringArgumentType.getString(ctx, ARG_VERBOSE_MODE), StringArgumentType.getString(ctx, ARG_STORAGE_ID)))))))
                                .then(Commands.literal("stop")
                                        .executes(this::cacheVerboseStop))))
                .then(Commands.literal("cache")
                ...
                .then(Commands.literal("benchmark")
                        .then(Commands.literal("start")
                                ...
                                .then(Commands.argument(ARG_PLAYERS, IntegerArgumentType.integer(1))
                                        .executes(ctx -> loadTestStart(ctx, IntegerArgumentType.getInteger(ctx, ARG_PLAYERS), 0))
                                        .then(Commands.argument(ARG_SECONDS, IntegerArgumentType.integer(1))
                                                .executes(ctx -> loadTestStart(ctx,
                                                        IntegerArgumentType.getInteger(ctx, ARG_PLAYERS),
                                                        IntegerArgumentType.getInteger(ctx, ARG_SECONDS))))))
                        .then(Commands.literal("stop")
                                .executes(this::loadTestStop))));
        ...
        root.then(Commands.literal("give")
                ...
                .then(Commands.argument(ARG_PLAYER, StringArgumentType.word())
                        .suggests(this::suggestPlayers)
                        .then(Commands.literal("storage")
                                .then(Commands.argument(ARG_TIER, StringArgumentType.word())
                                        .suggests(this::suggestTiers)
                                        .executes(ctx -> giveStorage(ctx, 1))
                                        .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                                .executes(ctx -> giveStorage(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT))))))
                        .then(Commands.literal("terminal")
                                .executes(ctx -> giveTerminal(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveTerminal(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("crafting_terminal")
                                .executes(ctx -> giveCraftingTerminal(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveCraftingTerminal(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("monitor")
                                .executes(ctx -> giveMonitor(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveMonitor(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("import_bus")
                                .executes(ctx -> giveImportBus(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveImportBus(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("export_bus")
                                .executes(ctx -> giveExportBus(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveExportBus(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("wire")
                                .executes(ctx -> giveWire(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveWire(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))
                        .then(Commands.literal("wireless_terminal")
                                .executes(ctx -> giveWireless(ctx, 1))
                                .then(Commands.argument(ARG_AMOUNT, IntegerArgumentType.integer(1))
                                        .executes(ctx -> giveWireless(ctx, IntegerArgumentType.getInteger(ctx, ARG_AMOUNT)))))));

        root.then(Commands.literal("reload")
                .executes(this::reload));

        root.then(Commands.literal("lang")
                .executes(this::usageLang)
                .then(Commands.literal("status")
                        .executes(this::langStatus))
                .then(Commands.literal("set")
                        .then(Commands.argument(ARG_LANG, StringArgumentType.word())
                                .suggests(this::suggestLangs)
                                .executes(this::langSet)))
                .then(Commands.literal("refresh")
                        .executes(this::langRefresh)));

        root.then(Commands.literal("mode")
                .executes(this::usageMode)
                .then(Commands.literal("info")
                        .executes(this::modeInfo))
                .then(Commands.literal("set")
    ...
    private int cacheStatus(CommandContext<CommandSourceStack> context) {
        ...
        try {
            storageId = java.util.UUID.fromString(raw).toString();
        ...
        org.bukkit.OfflinePlayer offline = online != null ? online : Bukkit.getOfflinePlayer(raw);
        ...
        plugin.getDatabase().getPlayerLastStorage(offline.getUniqueId()).thenAccept(result ->
                Bukkit.getScheduler().runTask(plugin, () -> {
                    if (result.isEmpty()) {
                        sender.sendMessage(plugin.getLang().tr("message.debug_player_none", playerName));
                        return;
                    }
    ...
    private void sendCacheStatus(CommandSender sender, String storageId) {
        ...
        if (cacheOpt.isEmpty() || !cacheOpt.get().isLoaded()) {
            ...
            long idleThresholdMs = Math.max(0L, plugin.getConfig().getLong("cache.idleUnloadSeconds", 300L) * 1000L);
            boolean dirty = cache.isDirty();
            int viewers = cache.viewerCount();
            sender.sendMessage(lang.tr("message.debug_cache_status_cache",
                    "true",
            ...
            if (touchSource != null) {
                ...
                sender.sendMessage(lang.tr("message.debug_cache_status_touch",
                        String.valueOf(touchAge),
                        String.valueOf(touchAge / 1000L),
                        touchSource));
            }
            boolean eligible = idleMs >= idleThresholdMs && !dirty && viewers <= 0 && !loading;
            sender.sendMessage(lang.tr("message.debug_cache_status_evict",
        ...
        org.bukkit.Location loc = findLoadedStorageLocation(storageId);
        ...
        sender.sendMessage(lang.tr("message.debug_cache_status_marker",
        ...
        if (!loaded) {
            ...
            sender.sendMessage(lang.tr("message.debug_cache_status_connections",
        ...
        org.bukkit.Chunk chunk = loc.getWorld().getChunkAt(cx, cz);
        var tickets = chunk.getPluginChunkTickets();
        String ticketNames = tickets.isEmpty() ? "-" : tickets.stream()
                .map(org.bukkit.plugin.Plugin::getName)
                .sorted(String.CASE_INSENSITIVE_ORDER)
                .reduce((a, b) -> a + ", " + b)
                .orElse("-");
        var players = chunk.getPlayersSeeingChunk();
        String playerNames = players.isEmpty() ? "-" : players.stream()
                .map(org.bukkit.entity.Player::getName)
                .sorted(String.CASE_INSENSITIVE_ORDER)
                .reduce((a, b) -> a + ", " + b)
                .orElse("-");
        sender.sendMessage(lang.tr("message.debug_cache_status_chunk",
    ...
    private String buildChunkReason(org.bukkit.Chunk chunk, String ticketNames, String playerNames) {
    ...
    private String spawnReason(org.bukkit.Chunk chunk) {
    ...
    private boolean isLinkedTerminal(org.bukkit.World world, String rawKey, String storageId) {
        int[] xyz = com.zxcmc.exort.core.marker.MarkerCoords.parseXYZ(rawKey.substring("terminal_".length()));
        if (xyz == null) return false;
        org.bukkit.block.Block block = world.getBlockAt(xyz[0], xyz[1], xyz[2]);
        if (!com.zxcmc.exort.core.marker.TerminalMarker.isTerminal(plugin, block)) return false;
        var result = com.zxcmc.exort.core.network.TerminalLinkFinder.find(
                block,
                plugin.getKeys(),
                plugin,
                plugin.getWireLimit(),
        ...
        return result.count() == 1 && result.data() != null && storageId.equals(result.data().storageId());
    }

    private boolean isLinkedMonitor(org.bukkit.World world, String rawKey, String storageId) {
        int[] xyz = com.zxcmc.exort.core.marker.MarkerCoords.parseXYZ(rawKey.substring("monitor_".length()));
        if (xyz == null) return false;
        org.bukkit.block.Block block = world.getBlockAt(xyz[0], xyz[1], xyz[2]);
        if (!com.zxcmc.exort.core.marker.MonitorMarker.isMonitor(plugin, block)) return false;
        var result = com.zxcmc.exort.core.network.TerminalLinkFinder.find(
                block,
                plugin.getKeys(),
                plugin,
    ...
    private boolean isLinkedBus(org.bukkit.World world, String rawKey, String storageId) {
        int[] xyz = com.zxcmc.exort.core.marker.MarkerCoords.parseXYZ(rawKey.substring("bus_".length()));
        if (xyz == null) return false;
        org.bukkit.block.Block block = world.getBlockAt(xyz[0], xyz[1], xyz[2]);
        if (!com.zxcmc.exort.core.marker.BusMarker.isBus(plugin, block)) return false;
        var result = com.zxcmc.exort.core.network.TerminalLinkFinder.find(
                block,
                plugin.getKeys(),
                plugin,
    ...
    private org.bukkit.Location findLoadedStorageLocation(String storageId) {
        ...
        for (org.bukkit.World world : Bukkit.getWorlds()) {
            for (org.bukkit.Chunk chunk : world.getLoadedChunks()) {
                ...
                for (var key : pdc.getKeys()) {
                    ...
                    String raw = pdc.get(key, org.bukkit.persistence.PersistentDataType.STRING);
                    if (raw == null || raw.isBlank()) continue;
                    String[] parts = raw.split(":");
                    if (parts.length < 2) continue;
                    if (!storageId.equals(parts[0])) continue;
                    int[] xyz = com.zxcmc.exort.core.marker.MarkerCoords.parseXYZ(rawKey.substring("storage_".length()));
                    if (xyz == null) continue;
                    return new org.bukkit.Location(world, xyz[0], xyz[1], xyz[2]);
                }
            }
        }
        return null;
    ...
    private int cacheVerboseStart(CommandContext<CommandSourceStack> context, String rawMode, String rawStorage) {
        if (!ensurePermission(context)) return 0;
        CommandSender sender = sender(context.getSource());
        var mode = com.zxcmc.exort.debug.CacheDebugService.Mode.fromString(rawMode);
        ...
        if (rawStorage != null && !rawStorage.isBlank()) {
            try {
                filter = java.util.UUID.fromString(rawStorage.trim());
        ...
        String modeName = (mode == null ? plugin.getCacheDebugService().getMode() : mode).name().toLowerCase(java.util.Locale.ROOT);
        String filterText = filter == null ? plugin.getLang().tr("message.debug_cache_filter_none") : filter.toString();
    ...
    private int loadTestStart(CommandContext<CommandSourceStack> context, int players, int durationSeconds) {
        if (!ensurePermission(context)) return 0;
    ...
    private int langRefresh(CommandContext<CommandSourceStack> context) {
        ...
        plugin.getItemNameService().refresh(normalized).thenAccept(status -> {
    ...
    private int langStatus(CommandContext<CommandSourceStack> context) {
        ...
        String indexLine = status.indexCached()
        ...
        if (!status.dictVersions().isEmpty()) {
            for (var entry : status.dictVersions().entrySet()) {
                ...
                sender.sendMessage(lang.tr("message.lang_status_dict", entry.getKey(), entry.getValue(), size));
            }
        }
        return 1;
    }
    ...
    private int langSet(CommandContext<CommandSourceStack> context) {
        ...
        if (!plugin.getItemNameService().isKnownLanguage(normalized)) {
            sender(context.getSource()).sendMessage(plugin.getLang().tr("message.lang_invalid", normalized));
            return 1;
        }
        plugin.getConfig().set("language", normalized);
        plugin.saveConfig();
        plugin.reloadRuntime().thenAccept(status ->
                sender.sendMessage(plugin.getLang().tr("message.lang_set", status.activeLanguage()))
        );
        return 1;
    }
    ...
    private int modeSet(CommandContext<CommandSourceStack> context) {
        ...
        plugin.saveConfig();
        plugin.reloadRuntime().thenRun(() -> sender.sendMessage(plugin.getLang().tr("message.mode_set", normalized)));
        return 1;
    }

    private int version(CommandContext<CommandSourceStack> context) {
        if (!ensurePermission(context)) return 0;
        sender(context.getSource()).sendMessage(plugin.getLang().tr("message.version", plugin.getPluginMeta().getVersion()));
        return 1;
    }
    ...
    private int debugPlayer(CommandContext<CommandSourceStack> context) {
        ...
        if (online != null) {
            ...
            if (session != null && session.getStorageLocation() != null) {
                ...
                sender.sendMessage(clickableDebugPlayer(
                        plugin.getLang().tr("message.debug_player_active",
                                online.getName(),
                                storageId,
                                session.getTier().key(),
                                loc.getWorld().getName(),
        ...
        plugin.getDatabase().getPlayerLastStorage(offline.getUniqueId()).thenAccept(result ->
                Bukkit.getScheduler().runTask(plugin, () -> {
                    ...
                    var data = result.get();
                    sender.sendMessage(clickableDebugPlayer(
                            plugin.getLang().tr("message.debug_player_last",
                                    playerName,
                                    data.storageId(),
                                    data.tier(),
                                    data.world(),
    ...
    private void openStorageById(String storageId, boolean write, Player viewer, CommandSender feedback) {
        plugin.getDatabase().getStorageTier(storageId).thenAccept(optTier ->
                Bukkit.getScheduler().runTask(plugin, () -> {
                    if (optTier.isEmpty()) {
                        feedback.sendMessage(plugin.getLang().tr("message.debug_storage_missing", storageId));
                        return;
                    }
                    ...
                    plugin.getStorageManager().getOrLoad(storageId).thenAccept(cache ->
                            Bukkit.getScheduler().runTask(plugin, () -> {
                                plugin.getSessionManager().openDebugSession(viewer, cache, tier, write);
                                feedback.sendMessage(plugin.getLang().tr("message.debug_storage_opened",
                                        storageId,
                                        write ? plugin.getLang().tr("debug.mode.write") : plugin.getLang().tr("debug.mode.read")));
                            })
                    );
                })
        );
    ...
    private Component clickableDebugPlayer(String message, String storageId) {
        ...
        Component idComponent = Component.text(storageId)
    ...
    private int giveStorage(CommandContext<CommandSourceStack> context, int amount) {
        ...
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, tier.displayName(), target.getName()));
        return 1;
    }
    ...
    private int giveTerminal(CommandContext<CommandSourceStack> context, int amount) {
        ...
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.terminal"), target.getName()));
        return 1;
    }
    ...
    private int giveCraftingTerminal(CommandContext<CommandSourceStack> context, int amount) {
        ...
        item.setAmount(giveAmount);
        target.getInventory().addItem(item);
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.crafting_terminal"), target.getName()));
        return 1;
    }
    ...
    private int giveMonitor(CommandContext<CommandSourceStack> context, int amount) {
        ...
        item.setAmount(giveAmount);
        target.getInventory().addItem(item);
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.monitor"), target.getName()));
        return 1;
    }
    ...
    private int giveImportBus(CommandContext<CommandSourceStack> context, int amount) {
        ...
        item.setAmount(giveAmount);
        target.getInventory().addItem(item);
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.import_bus"), target.getName()));
        return 1;
    }
    ...
    private int giveExportBus(CommandContext<CommandSourceStack> context, int amount) {
        ...
        item.setAmount(giveAmount);
        target.getInventory().addItem(item);
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.export_bus"), target.getName()));
        return 1;
    }
    ...
    private int giveWire(CommandContext<CommandSourceStack> context, int amount) {
        ...
        item.setAmount(giveAmount);
        target.getInventory().addItem(item);
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.wire"), target.getName()));
        return 1;
    }
    ...
    private int giveWireless(CommandContext<CommandSourceStack> context, int amount) {
        ...
        sender.sendMessage(plugin.getLang().tr("message.give_success", giveAmount, plugin.getLang().tr("item.wireless_terminal"), target.getName()));
        return 1;
    }
    ...
    private CompletableFuture<Suggestions> suggestPlayers(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
        ...
        List<String> matches = StringUtil.copyPartialMatches(builder.getRemaining().toLowerCase(Locale.ROOT), options, new ArrayList<>());
        matches.forEach(builder::suggest);
        return builder.buildFuture();
    }

    private CompletableFuture<Suggestions> suggestTiers(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
        List<String> options = new ArrayList<>();
    ...
    private CompletableFuture<Suggestions> suggestLangs(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
    ...
    private CompletableFuture<Suggestions> suggestVerboseModes(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
    ...
    private CompletableFuture<Suggestions> suggestModes(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
        ...
        List<String> matches = StringUtil.copyPartialMatches(builder.getRemaining().toUpperCase(Locale.ROOT), options, new ArrayList<>());
        matches.forEach(builder::suggest);
        return builder.buildFuture();
    }

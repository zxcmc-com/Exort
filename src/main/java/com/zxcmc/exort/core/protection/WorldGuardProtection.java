...
public final class WorldGuardProtection implements RegionProtection {
    ...
    public WorldGuardProtection() {
        try {
            ...
            Class<?> eventsClass = Class.forName("com.sk89q.worldguard.bukkit.util.Events", false, loader);
            Class<?> placeClass = Class.forName("com.sk89q.worldguard.bukkit.event.block.PlaceBlockEvent", false, loader);
            Class<?> breakClass = Class.forName("com.sk89q.worldguard.bukkit.event.block.BreakBlockEvent", false, loader);
            Class<?> useClass = Class.forName("com.sk89q.worldguard.bukkit.event.block.UseBlockEvent", false, loader);

            causeCreate = causeClass.getMethod("create", Object[].class);
            fireAndTest = eventsClass.getMethod("fireAndTestCancel", Event.class);
            placeCtor = placeClass.getConstructor(Event.class, causeClass, Location.class, Material.class);

...
public final class GuiItems {
  ...
  public static final String HEAD_NEXT_PAGE =
  ...
  public static final String HEAD_PREV_PAGE =
  ...
  public static final String HEAD_SORT =
  ...
  public static final String HEAD_INFO =
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTZkNTU0YWQ1ZTBkYzYwMWVmYmI5MjVkMTM0MjRjY2VhNTMyYzgzMWE5MGI5Y2E3M2Q1ZTkzYWI2ZGJjNWRhZiJ9fX0=";
  public static final String HEAD_SEARCH =
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMDlhNTJjYjUwOTkyZDgzYzU1OTlmZDZlNDFhNmNlOTljZjdmMWU2MjAzNjExOTYzZGMyYzJmZGEwYjU1NTgzIn19fQ==";
  public static final String HEAD_CRAFT_STORAGE =
  ...
  public static final String HEAD_CRAFT_PLAYER =
  ...
  public static ItemStack button(
      Material vanillaMaterial, Component name, List<Component> lore, boolean useFillers) {
  ...
  public static ItemStack craftStorageButton(
      Component name, List<Component> lore, boolean useFillers) {
    return headButton(HEAD_CRAFT_STORAGE, Material.CRAFTING_TABLE, name, lore, useFillers);
  }

  public static ItemStack craftPlayerButton(
      Component name, List<Component> lore, boolean useFillers) {
  ...
  private static ItemStack headButton(
      String texture,
      ...
      boolean useFillers) {
    Material base =
        useFillers ? (texture == null ? vanillaFallback : Material.PLAYER_HEAD) : Material.PAPER;
    ItemStack item = new ItemStack(base);
    ItemMeta meta = item.getItemMeta();
    if (meta != null) {
      if (name != null) {

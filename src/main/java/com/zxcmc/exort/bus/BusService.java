...
public final class BusService {
    ...
    public BusService(ExortPlugin plugin,
        ...
        this.engine = new BusEngine(plugin, storageManager, busCarrier, activeIntervalTicks, idleIntervalTicks,
                itemsPerOperation, maxOperationsPerTick, maxOperationsPerChunk, allowStorageTargets, wirelessService, registry);
    }
    ...
    public BusState getOrCreateState(BusPos pos, com.zxcmc.exort.core.marker.BusMarker.Data marker, Block busBlock) {
    ...
    public void scanChunk(org.bukkit.Chunk chunk) {

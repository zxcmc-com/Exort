...
public final class FaweExtentAccess {
  ...
  public static ConfigResult allowMarkerExtentInConfig(File configFile, String extentClass) {
  ...
  public static boolean shouldLogWarning(Result result) {
    return shouldLogWarning(result, ALLOWED_PLUGINS_KEY);
  }

  public static boolean shouldLogWarning(Result result, String warningKey) {
    if (result == null) {
      return false;
    }
  ...
  public record Result(
    ...
    public String infoMessage(String extentClass) {
      return infoMessage("marker", extentClass);
    }

    public String infoMessage(String label, String extentClass) {
      return "[WorldEdit] Added FAWE " + label + " extent to allowed-plugins: " + extentClass;
    }

    public String warningMessage(String extentClass) {
      return warningMessage("marker", extentClass);
    }

    public String warningMessage(String label, String extentClass) {
